...
<div class="container " style="padding: 10px 0 30px 0">
    <div class="row">
      <div class="col-md-4" style="padding:50px;">
        <button type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href='setgoals.php'">Set Goals</button>
      </div>
      <div class="col-md-4" style="padding:50px;">

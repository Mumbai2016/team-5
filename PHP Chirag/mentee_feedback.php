...
$query="SELECT * from assign_mentor_mentee where mentee_id='$mentee_id'";
...
$query4="INSERT INTO `mentee_feedback`(`feedback`, `meeting_id`, `created_by`, `edited_by`, `created_at`, `updated_at`, `minutes`, `interact`, `fruitful`, `interest`, `comfort`) VALUES ('$feedback',$meeting_id,'$mentee_id','$mentee_id',now(),now(),'$minutes','$interact','$fruitful','$interest','$comfort')";
...
<body>
    ...
    <form action="mentee_feedback.php" action="GET">
        <table>
        <tr>
        <td>
        Date:
        ...
        <tr>
        <td>
        Was the mentor able to interact well?:</td>
         <td>
         ...
         <tr>
             ...
             Was the session fruitful?:</td>
              ...
              <tr>
          <td>
          Did the mentor take active interest?:</td>
           <td>
           ...
           <tr>
                   <td>
                   Was the mentor comfortable to interact:</td>
                    <td>
                    <select name="comfort">
                           <option value=""></option>
                           <option value="y">Yes</option>
